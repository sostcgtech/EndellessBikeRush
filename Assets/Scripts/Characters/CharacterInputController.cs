...
///// <summary>
///// Handle everything related to controlling the motorcycle. Interact with both the Motorcycle (visual, animation) and CharacterCollider
///// </summary>
...
//    public Character character; // Keep the name for compatibility, but attach Motorcycle script
...
//        // Notify motorcycle it's moving (for wheel spinning, etc.)
//        Motorcycle motorcycle = character as Motorcycle;
//        if (motorcycle != null)
//        {
//            motorcycle.SetMoving(true);
//        }
//    }
...
//        // Notify motorcycle it stopped moving
//        Motorcycle motorcycle = character as Motorcycle;
//        if (motorcycle != null)
//        {
//            motorcycle.SetMoving(false);
//        }
//    }
...
//            // This is for gameplay reason, we don't want the motorcycle to drastically slide farther when at max speed.
...
//        // Put blob shadow under the motorcycle.
//        RaycastHit hit;
...
//            // Play jump sound (engine rev for motorcycle)
//            if (character != null && character.jumpSound != null && m_Audio != null)
//            {
...
//            float animSpeed = k_TrackSpeedToSlideAnimSpeedRatio * (trackManager.speed / correctSlideLength);
...
//            // Play slide sound
//            if (slideSound != null && m_Audio != null)
//            {
...
//            // Enable slide particle effects (sparks, etc.)
//            Motorcycle motorcycle = character as Motorcycle;
//            if (motorcycle != null)
//            {
//                motorcycle.SetSlideEffect(true);
//            }
...
//            // Disable slide particle effects
//            Motorcycle motorcycle = character as Motorcycle;
//            if (motorcycle != null)
//            {
//                motorcycle.SetSlideEffect(false);
//            }
...
//    {
//        if (characterCollider != null && characterCollider.audio != null && powerUpUseSound != null)
//        {
